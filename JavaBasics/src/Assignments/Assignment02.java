...
public class Assignment02 {
	...
	public static void callPrimitiveDataTypes() {
	...
	public void callNonPrimitiveDataType() {
	...
	public static void main(String[] args) {
		...
		callPrimitiveDataTypes(); // Static method no need to create an object class
		Assignment02 as2 = new Assignment02(); // Non Static method should be create an object
		as2.callNonPrimitiveDataType();
	}
